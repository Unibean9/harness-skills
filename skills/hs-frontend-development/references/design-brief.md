...
Based on the brief, list which reference files would be most valuable during implementation (e.g., space.md for complex layouts, motion.md for animated features, interaction-design.md for form-heavy features, type.md for typography-driven pages, color.md for color-led brands).
