...
<!-- GENERATED from docs/agents.md's "## hs-scout" section; run `npm exec -- hs agents --target antigravity` -->
<!-- model intentionally unset: pick your CLI's cheapest model that can still read and summarize; hs-scout is retrieval-only -->
